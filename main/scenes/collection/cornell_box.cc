...
auto cornellBoxAdvanced(RenderSettings const& settings) -> Composition
{
  auto camera = trace::Camera{ settings.imageWidth,
    settings.imageHeight,
    lina::Vec3{ 0.0, -95.0, 50.0 },// camera center
    lina::Vec3{ 0.0, 0.0, 50.0 },// look at
    lina::Vec3{ 0.0, 0.0, 1.0 },
    settings.degreesVerticalFOV,
    settings.defocusAngle,
  ...
  auto bottom =
    trace::buildPlane(lina::Vec3{ 0.0, -50.0, 0.0 }, 100.0, 200.0, trace::Axis::Z, trace::Orientation::Aligned);
  auto top =
    trace::buildPlane(lina::Vec3{ 0.0, -50.0, 100.0 }, 100.0, 200.0, trace::Axis::Z, trace::Orientation::Reverse);
  auto front =
    trace::buildPlane(lina::Vec3{ 0.0, -100.0, 50.0 }, 100.0, 100.0, trace::Axis::Y, trace::Orientation::Aligned);
  auto back =
    trace::buildPlane(lina::Vec3{ 0.0, 50.0, 50.0 }, 100.0, 100.0, trace::Axis::Y, trace::Orientation::Reverse);
  auto left =
    trace::buildPlane(lina::Vec3{ -50.0, -50.0, 50.0 }, 100.0, 200.0, trace::Axis::X, trace::Orientation::Aligned);
  auto right =
    trace::buildPlane(lina::Vec3{ 50.0, -50.0, 50.0 }, 100.0, 200.0, trace::Axis::X, trace::Orientation::Reverse);

  sceneElements.emplace_back(std::make_unique<trace::Plane>(std::move(bottom)),
    std::make_unique<trace::Lambertian>(lina::Vec3{ 0.9296, 0.9179, 0.8476 }));
  sceneElements.emplace_back(std::make_unique<trace::Plane>(std::move(top)),
    std::make_unique<trace::Lambertian>(lina::Vec3{ 0.9296, 0.9179, 0.8476 }));
  sceneElements.emplace_back(std::make_unique<trace::Plane>(std::move(front)),
    std::make_unique<trace::Lambertian>(lina::Vec3{ 0.07, 0.039, 0.5586 }));
  sceneElements.emplace_back(std::make_unique<trace::Plane>(std::move(back)),
    std::make_unique<trace::Lambertian>(lina::Vec3{ 0.07, 0.039, 0.5586 }));
  sceneElements.emplace_back(std::make_unique<trace::Plane>(std::move(left)),
  ...
  cuboidOne->Transform(trace::rotateAlongZ(trace::degreesToRadians(30)));
  sceneElements.emplace_back(
    std::move(cuboidOne), std::make_unique<trace::Metal>(lina::Vec3{ 0.8, 0.85, 0.88 }));// aluminium

  auto sphere = std::make_unique<trace::Icosphere>(trace::buildIcosphere(lina::Vec3{ 22.0, -8.0, 17.5 }, 35.0, 4));
  sceneElements.emplace_back(std::move(sphere), std::make_unique<trace::Dielectric>(1.4));
