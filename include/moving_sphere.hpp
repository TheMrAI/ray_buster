...
public:
    ...
    moving_sphere(vec3 begin_center, vec3 end_center, double begin_time, double end_time, double radius, std::shared_ptr<material> material_ptr) : 
        begin_center_{begin_center},
