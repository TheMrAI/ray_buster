...
{
  auto sphere = trace::buildSphere(lina::Vec3{ 0.0, 0.0, 0.0 }, 1.0, 0);
...
TEST(Sphere, IcosahedronAfterOneSubdivision)
{
  ...
  auto sphere = trace::buildSphere(lina::Vec3{ 0.0, 0.0, 0.0 }, 1.0, 1);
  auto const& mesh = sphere.GetMesh();
...
TEST(Sphere, IcosahedronAfterTwoSubdivision)
{
  ...
  auto sphere = trace::buildSphere(lina::Vec3{ 0.0, 0.0, 0.0 }, 1.0, 2);
  auto const& mesh = sphere.GetMesh();
...
TEST(Sphere, IcosahedronAfterThreeSubdivision)
{
  auto sphere = trace::buildSphere(lina::Vec3{ 0.0, 0.0, 0.0 }, 1.0, 3);
  auto const& mesh = sphere.GetMesh();
